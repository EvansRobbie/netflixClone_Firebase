...
const SignUp = () => {
    const {email, password, handleEmail, handlePassword} = useGlobalContext()
            ...
            <div className='fixed w-full px-4 py-24 '>
                <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white rounded-md'>
                    <div className='max-w-[320px] mx-auto py-16'>
                        <h1 className='capitalize text-2xl font-semibold '>Sign up</h1>
                        <form onSubmit={handleSubmit} className='w-full flex flex-col py-4'>
                            ...
                            <button className='bg-red-600 py-3 my-6 rounded font-bold capitalize'>sign up</button>
